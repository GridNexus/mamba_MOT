...
# Try mmdet 3.x import first, fall back to mmdet 2.x
try:
    from mmdet.registry import MODELS as MODELS_MMDET
    from mmdet.registry import MODELS as BACKBONES
    MODELS_MMSEG = None  # Disable mmseg support for now
except ImportError:
    # mmdet 2.x uses different import paths
    from mmdet.models.builder import BACKBONES
    MODELS_MMDET = BACKBONES
    MODELS_MMSEG = None  # Disable mmseg support for now
...
# Simple registry for mmdet 2.x compatibility if needed
...
if MODELS_MMDET is None:
    MODELS_MMDET = SimpleRegistry()
if MODELS_MMSEG is None:
    MODELS_MMSEG = SimpleRegistry()
